...
if ( !sizeof( $_REQUEST ) )
{
    ...
    error_mail( $msg . "Error occured in analyze synctest.\n" );
...
$cmd = isset( $_REQUEST[ '_docrootexecutable' ] ) ? "/opt/lampp/htdocs/psptest/" . $_REQUEST[ '_docrootexecutable' ] : "/home/priyanshu-sekhar/gsoc/new_airavata/new_genapp/psptest/bin/synctest";
