void psptest::module_load_simulate_simulate_2()
{
...
void psptest::module_reset_simulate_simulate_2()
{
   reset_default_values();
}

void psptest::module_submit_simulate_simulate_2()
{
   save_last_values();
   ...
   QString program = "/home/priyanshu-sekhar/airavata-sandbox/genapp-airavata-gsoc2015/GenApp-Priyanshu/psptest/bin/simulate_2";
   ...
   string tprojId = createProject("user", "simulate_2");
...
void psptest::readyReadStandardOutput_simulate_simulate_2()
{
   process_json[ "simulate_2" ] += QString( process_simulate_simulate_2->readAllStandardOutput() );
}

void psptest::readyReadStandardError_simulate_simulate_2()
{
   qDebug() << process_simulate_simulate_2->readAllStandardError();
}

void psptest::error_simulate_simulate_2( QProcess::ProcessError e )
{
   qDebug() << "process_simulate_simulate_2->error()" << e;
}

void psptest::finished_simulate_simulate_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_simulate_simulate_2->finished()";
