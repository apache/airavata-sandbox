void psptest::module_load_build_build_1()
{
...
void psptest::module_reset_build_build_1()
{
   reset_default_values();
}

void psptest::module_submit_build_build_1()
{
   save_last_values();
   ...
   QString program = "/home/priyanshu-sekhar/airavata-sandbox/genapp-airavata-gsoc2015/GenApp-Priyanshu/psptest/bin/build_1";
   ...
   string tprojId = createProject("user", "build_1");
...
void psptest::readyReadStandardOutput_build_build_1()
{
   process_json[ "build_1" ] += QString( process_build_build_1->readAllStandardOutput() );
}

void psptest::readyReadStandardError_build_build_1()
{
   qDebug() << process_build_build_1->readAllStandardError();
}

void psptest::error_build_build_1( QProcess::ProcessError e )
{
   qDebug() << "process_build_build_1->error()" << e;
}

void psptest::finished_build_build_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_build_build_1->finished()";
