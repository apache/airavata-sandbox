void psptest::module_load_build_build_2()
{
...
void psptest::module_reset_build_build_2()
{
   reset_default_values();
}

void psptest::module_submit_build_build_2()
{
   save_last_values();
   ...
   //QString program = "/home/priyanshu-sekhar/airavata-sandbox/genapp-airavata-gsoc2015/GenApp-Priyanshu/psptest/bin/build_2";
   ...
   string tprojId = createProject("user", "build_2");
...
void psptest::readyReadStandardOutput_build_build_2()
{
   process_json[ "build_2" ] += QString( process_build_build_2->readAllStandardOutput() );
}

void psptest::readyReadStandardError_build_build_2()
{
   qDebug() << process_build_build_2->readAllStandardError();
}

void psptest::error_build_build_2( QProcess::ProcessError e )
{
   qDebug() << "process_build_build_2->error()" << e;
}

void psptest::finished_build_build_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_build_build_2->finished()";
