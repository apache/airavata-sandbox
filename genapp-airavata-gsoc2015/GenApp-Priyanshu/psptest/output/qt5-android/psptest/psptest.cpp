...
{
   {
      QFile sf( ":/stylesheets/style.qss" );
   ...
   int gl_menu_pos = 0;
   {
      ...
      id_to_icon [ "tools" ] = QPixmap::fromImage( QImage( QString( ":images/pngs/tools.png" ) ).scaled( 60, 80, Qt::KeepAspectRatio ) );
   ...
   }
   {
      ...
      id_to_icon [ "build" ] = QPixmap::fromImage( QImage( QString( ":images/pngs/build.png" ) ).scaled( 60, 80, Qt::KeepAspectRatio ) );
      mQLabel* lbl = new mQLabel( "", this );
   ...
   }
   {
      ...
      id_to_icon [ "interact" ] = QPixmap::fromImage( QImage( QString( ":images/pngs/interact.png" ) ).scaled( 60, 80, Qt::KeepAspectRatio ) );
      mQLabel* lbl = new mQLabel( "", this );
   ...
   }
   {
      ...
      id_to_icon [ "simulate" ] = QPixmap::fromImage( QImage( QString( ":images/pngs/simulate.png" ) ).scaled( 60, 80, Qt::KeepAspectRatio ) );
      mQLabel* lbl = new mQLabel( "", this );
   ...
   }
   {
      ...
      id_to_icon [ "calculate" ] = QPixmap::fromImage( QImage( QString( ":images/pngs/calculate.png" ) ).scaled( 60, 80, Qt::KeepAspectRatio ) );
      mQLabel* lbl = new mQLabel( "", this );
   ...
   }
   {
      ...
      id_to_icon [ "analyze" ] = QPixmap::fromImage( QImage( QString( ":images/pngs/analyze.png" ) ).scaled( 60, 80, Qt::KeepAspectRatio ) );
      mQLabel* lbl = new mQLabel( "", this );
