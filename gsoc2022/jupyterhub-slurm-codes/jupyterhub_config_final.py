...
#  Default: 'http://:8000'
c.JupyterHub.bind_url = 'http://10.0.6.24:8000'
...
#  Default: '/opt/python3/share/jupyterhub'
# c.JupyterHub.data_files_path = '/opt/python3/share/jupyterhub'
...
c.BatchSpawnerBase.req_host = 'jupyterhub-slurm' #JEC_SPAWNER_HOSTNAME 
...
# to avoid https://github.com/jupyter/notebook/issues/1318
...
sudo docker pull himanshuhansaria/jhub-gsoc2:latest
sudo docker run -dit --name jhub_container himanshuhansaria/jhub-gsoc2:latest /bin/bash
echo "Docker container started ."
echo "Running batchspawner"
#sudo docker exec jhub_container {{cmd}}
{{cmd}}
...
#------------------------------------------------------------------------------
# Values needed by the django portal
#KEYCLOAK_AUTHORIZE_URL = 'https://iam.scigap.org/auth/realms/delta/protocol/openid-connect/auth'
#KEYCLOAK_TOKEN_URL = 'https://iam.scigap.org/auth/realms/delta/protocol/openid-connect/token'
#KEYCLOAK_USERINFO_URL = 'https://iam.scigap.org/auth/realms/delta/protocol/openid-connect/userinfo'
#KEYCLOAK_LOGOUT_URL = 'https://iam.scigap.org/auth/realms/delta/protocol/openid-connect/logout'
...
import os
public_hostname = 'FILL-ME-IN' #JEC_PUBLIC_HOSTNAME
